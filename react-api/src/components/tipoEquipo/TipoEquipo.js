...
import { borrarTipoEquipoPorID, crearTipoEquipo, editarTipoEquipoPorID, obtenerTipoEquipo } from '../../services/TipoEquipoServices'
...
export default function TipoEquipo() {
  ...
  const setTipoPorId = (e) => {
    ...
    const tiposFilter = tipoEquipo.filter(t => t._id === e.target.id);
